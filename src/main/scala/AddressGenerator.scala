...
case class Config(count: Int = 1, testnet: Boolean = false)

object AddressGenerator extends App {

  val parser = new OptionParser[Config]("addressgenerator") {
    head("Waves address generator", "1.0")
